...
@implementation DevideOperation
static DevideOperation *sharedState = nil;
+ (DevideOperation *)sharedManager {
    if (sharedState == nil) {
...
- (NSString *)calculationOperandA:(NSDecimalNumber *)opeA withOperandB:(NSDecimalNumber *)opeB
{
    ...
    @try {
        NSDecimalNumber *resultNumer = [opeA decimalNumberByDividingBy:opeB];
